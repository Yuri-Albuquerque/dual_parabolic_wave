...
export class OptimizedWaveField {
  ...
  private updateCallbacks: Array<(grid: Float32Array, time: number) => void> = [];
  ...
  public onUpdate(callback: (grid: Float32Array, time: number) => void): void {
    this.updateCallbacks.push(callback);
  }

  public async update(dt: number, steps: number = 1): Promise<void> {
