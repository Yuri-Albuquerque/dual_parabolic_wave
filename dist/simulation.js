...
exports.DualParabolicWaveSimulation = void 0;
const parabola_1 = require("./parabola");
const optimizedWaveField_1 = require("./optimizedWaveField");
class DualParabolicWaveSimulation {
    constructor() {
        ...
        this.renderInterval = 1000 / 30; // 30 FPS for rendering
        this.simulationStepsPerFrame = 10; // Multiple physics steps per render
        this.animate = () => {
    ...
    setupParabolas() {
        ...
        this.majorParabola = new parabola_1.Parabola(majorDiameter, majorFocus, majorVertex, false);
        // Minor parabola (bowl, concave up)
        // Vertex is 50mm below focus point
        const minorVertex = { x: 0, y: -minorFocus };
        this.minorParabola = new parabola_1.Parabola(minorDiameter, minorFocus, minorVertex, true);
    }
    setupWaveParameters() {
    ...
    initializeWaveField() {
        this.waveField = new optimizedWaveField_1.OptimizedWaveField(this.config, this.waveParams, this.focusPoint);
        // Set up update callback for asynchronous updates
        this.waveField.onUpdate((grid, time) => {
    ...
    drawParabolas() {
        ...
        const xToCanvas = (x) => ((x - xRange[0]) / (xRange[1] - xRange[0])) * canvasWidth;
        const yToCanvas = (y) => ((yRange[1] - y) / (yRange[1] - yRange[0])) * canvasHeight;
...
exports.DualParabolicWaveSimulation = DualParabolicWaveSimulation;
